...
- “I want to rent out my property and need something legally binding ,landlord ,housewoner” → Type: Lease Agreement
...
You are a legal AI assistant tasked with drafting a complete {document_type} using the following information:

{collected_info}

Use the official legal template associated with {document_type}. Fill in **all placeholders completely and realistically** using the provided details. If any optional information is not provided, omit the section cleanly without leaving empty brackets, "insert data here", or blank lines.

The final document must:
- Be formatted professionally
- Avoid any placeholders or incomplete fields
- Ensure all date fields are filled using today's date ({date}), even if not explicitly mentioned
- Ensure the tone is legally accurate and polished
"""
